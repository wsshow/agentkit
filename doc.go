...
// persist sessions and goals, delegate to isolated subagents, compact long
// contexts, load reusable skills, and manage MCP connections. Prompt, Send,
// Continue, and Resume block until a run completes and are mutually exclusive
// for each Agent. Subscribe delivers ordered, synchronous event snapshots for
// streaming output and lifecycle observation.
//
